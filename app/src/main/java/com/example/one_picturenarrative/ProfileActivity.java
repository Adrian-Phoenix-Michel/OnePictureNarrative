    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.menu_stories:
                Intent stories= new Intent(ProfileActivity.this, HomeActivity.class);
                startActivity(stories);
                break;
            case R.id.menu_create:
                Intent create= new Intent(ProfileActivity.this, CreationActivity.class);
            ...
            case R.id.menu_signoff:
                Intent signoff= new Intent(ProfileActivity.this, LoginActivity.class);
